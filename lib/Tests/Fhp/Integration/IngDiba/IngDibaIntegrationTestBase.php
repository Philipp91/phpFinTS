...
class IngDibaIntegrationTestBase extends FinTsTestCase
{
    ...
    const INIT_REQUEST = "HNHBK:1:3+000000000481+300+0+1'HNVSK:998:3+PIN:1+998+1+1::FAKEKUNDENSYSTEMIDabcdefghijkl+1:20190102:030405+2:2:13:@8@00000000:5:1+280:50010517:test?@user:V:0:0+0'HNVSD:999:1+@289@HNSHK:2:4+PIN:1+999+9999999+1+1+1::FAKEKUNDENSYSTEMIDabcdefghijkl+1+1:20190102:030405+1:999:1+6:10:19+280:50010517:test?@user:S:0:0'HKIDN:3:2+280:50010517+test?@user+FAKEKUNDENSYSTEMIDabcdefghijkl+1'HKVVB:4:3+7+0+0+123456789ABCDEF0123456789+1.0'HKTAN:5:6+4+HKIDN'HNSHA:6:2+9999999++123456''HNHBS:7:1+1'";
